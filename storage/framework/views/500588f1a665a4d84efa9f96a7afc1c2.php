...
<?php $__env->startSection('title', "Modifier le Joueur"); ?>

<?php $__env->startSection('header'); ?>
    Modifier le Joueur (Saison : <?php echo e($saison?->nom ?? 'Aucune'); ?>)
...
<?php endif; ?>
    <?php endif; ?>
    <form action="<?php echo e(route('admin.joueurs.update', $joueur)); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
        <?php echo csrf_field(); ?>
        <?php echo method_field('PUT'); ?>
        <div>
            <label class="block text-white font-semibold mb-1">Nom</label>
            <input type="text" name="nom" class="w-full mt-1 p-3 border border-bl-border rounded bg-bl-dark text-white focus:ring-2 focus:ring-bl-accent focus:border-bl-accent transition" required value="<?php echo e(old('nom', $joueur->nom)); ?>">
            <?php $__errorArgs = ['nom'];
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            ...
            <input type="text" name="prenom" class="w-full mt-1 p-3 border border-bl-border rounded bg-bl-dark text-white focus:ring-2 focus:ring-bl-accent focus:border-bl-accent transition" required value="<?php echo e(old('prenom', $joueur->prenom)); ?>">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            ...
            <input type="date" name="date_naissance" class="w-full mt-1 p-3 border border-bl-border rounded bg-bl-dark text-white focus:ring-2 focus:ring-bl-accent focus:border-bl-accent transition" required value="<?php echo e(old('date_naissance', $joueur->date_naissance)); ?>">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            ...
            <input type="text" name="poste" class="w-full mt-1 p-3 border border-bl-border rounded bg-bl-dark text-white focus:ring-2 focus:ring-bl-accent focus:border-bl-accent transition" required value="<?php echo e(old('poste', $joueur->poste)); ?>">
        ...
        <div>
            ...
            <select name="equipe_id" class="w-full mt-1 p-3 border border-bl-border rounded bg-bl-dark text-white focus:ring-2 focus:ring-bl-accent focus:border-bl-accent transition">
                ...
                <?php $__currentLoopData = $equipes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $equipe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($equipe->id); ?>" <?php if(old('equipe_id', $joueur->equipe_id) == $equipe->id): ?> selected <?php endif; ?>><?php echo e($equipe->nom); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
            <?php $__errorArgs = ['equipe_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="text-red-400 text-sm mt-1"><?php echo e($message); ?></div><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            ...
            <?php if($joueur->photo): ?>
                <div class="mt-2">
                    <img src="<?php echo e(asset('storage/' . $joueur->photo)); ?>" alt="Photo actuelle" class="h-12 w-12 rounded-full object-cover border border-bl-border bg-bl-dark" onerror="this.style.display='none'">
                </div>
            <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            ...
            <input type="text" name="numero_licence" class="w-full mt-1 p-3 border border-bl-border rounded bg-bl-dark text-white focus:ring-2 focus:ring-bl-accent focus:border-bl-accent transition" value="<?php echo e(old('numero_licence', $joueur->numero_licence)); ?>">
            <?php $__errorArgs = ['numero_licence'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="text-red-400 text-sm mt-1"><?php echo e($message); ?></div><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            ...
            <input type="text" name="numero_dossard" class="w-full mt-1 p-3 border border-bl-border rounded bg-bl-dark text-white focus:ring-2 focus:ring-bl-accent focus:border-bl-accent transition" value="<?php echo e(old('numero_dossard', $joueur->numero_dossard)); ?>">
            <?php $__errorArgs = ['numero_dossard'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="text-red-400 text-sm mt-1"><?php echo e($message); ?></div><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            ...
            <input type="text" name="nationalite" class="w-full mt-1 p-3 border border-bl-border rounded bg-bl-dark text-white focus:ring-2 focus:ring-bl-accent focus:border-bl-accent transition" value="<?php echo e(old('nationalite', $joueur->nationalite)); ?>">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="flex items-center gap-4 mt-6">
            ...
            <a href="<?php echo e(route('admin.joueurs.index')); ?>" class="text-gray-400 hover:text-bl-accent underline transition">Annuler</a>
        </div>
    </form>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\MIKE KIBWE\Documents\Learning\UDBL\L4 GL\TFC\Application\Euflu\resources\views/admin/joueurs/edit.blade.php ENDPATH**/ ?>