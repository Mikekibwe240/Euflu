...
<?php $__env->startSection('title', 'Actualités EUFLU'); ?>
...
<div class="max-w-6xl mx-auto mb-10">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        <?php $__currentLoopData = $others; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a href="<?php echo e(route('public.articles.show', $article->id)); ?>" class="block group">
                <div class="flex flex-col md:flex-row bg-[#181d1f] rounded-lg shadow-lg overflow-hidden border border-[#23272a] transition hover:shadow-xl hover:border-[#e2001a]">
                    ...
                    <div class="flex-1 p-6 flex flex-col justify-between">
                        <div>
                            ...
                            <h3 class="text-xl font-bold text-white mb-2 leading-tight group-hover:text-[#e2001a]"><?php echo e($article->titre); ?></h3>
