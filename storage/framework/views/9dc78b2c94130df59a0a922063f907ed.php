...
<div class="container mx-auto p-4">
    ...
    <?php
        ...
        $saisonSelected = old('saison_id', $article->saison_id ?? $saisonCourante?->id);
    ?>
    <form action="<?php echo e(route('admin.articles.update', $article)); ?>" method="POST" enctype="multipart/form-data" class="space-y-4 bg-white dark:bg-gray-800 p-6 rounded shadow text-gray-900 dark:text-gray-100">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            ...
            <textarea name="contenu" id="contenu" class="form-input w-full bg-gray-50 dark:bg-gray-900 border-gray-300 dark:border-gray-700 text-gray-900 dark:text-gray-100" rows="6" required><?php echo e(old('contenu', $article->contenu)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            ...
            ?>
            <input type="datetime-local" name="published_at" id="published_at" class="form-input w-full" value="<?php echo e($publishedAt ? $publishedAt->format('Y-m-d\TH:i') : ''); ?>">
