...
<?php $__env->startSection('title', 'Transferts de joueurs'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.alert','data' => ['type' => 'success','message' => session('success'),'class' => 'mb-6']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
    <?php endif; ?>
    <form method="POST" action="<?php echo e(route('admin.transferts.store')); ?>" class="space-y-6 bg-bl-card p-6 rounded-lg shadow border border-bl-border">
        <?php echo csrf_field(); ?>
        <div>
...
const joueurs = <?php echo json_encode($joueurs_json, 15, 512) ?>;
const equipes = <?php echo json_encode($equipes_json, 15, 512) ?>;
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\MIKE KIBWE\Documents\Learning\UDBL\L4 GL\TFC\Application\Euflu\resources\views/admin/transferts/index.blade.php ENDPATH**/ ?>