...
<div class="container mx-auto p-4">
    ...
    <?php endif; ?>
    <form action="<?php echo e(route('admin.rencontres.updateResultat', $rencontre)); ?>" method="POST" class="space-y-4 bg-white dark:bg-gray-800 p-6 rounded shadow">
        <?php echo csrf_field(); ?>
        <?php echo method_field('PUT'); ?>
        <div class="flex gap-4 items-center">
            <span class="font-semibold text-gray-900 dark:text-gray-100">
                <?php if($rencontre->equipe1_libre): ?>
                    <span class="italic text-gray-500 dark:text-gray-300"><?php echo e($rencontre->equipe1_libre); ?></span>
            ...
            <input type="number" name="score_equipe1" value="<?php echo e(old('score_equipe1', $rencontre->score_equipe1)); ?>" class="form-input w-16 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 border-gray-300 dark:border-gray-700" min="0" required>
            <span class="mx-2 text-gray-900 dark:text-gray-100">-</span>
            <input type="number" name="score_equipe2" value="<?php echo e(old('score_equipe2', $rencontre->score_equipe2)); ?>" class="form-input w-16 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 border-gray-300 dark:border-gray-700" min="0" required>
            <span class="font-semibold text-gray-900 dark:text-gray-100">
                <?php if($rencontre->equipe2_libre): ?>
                    <span class="italic text-gray-500 dark:text-gray-300"><?php echo e($rencontre->equipe2_libre); ?></span>
                ...
                <div id="buteurs-equipe1-list">
                    ...
                    <?php for($i = 0; $i < $nb; $i++): ?>
                        <div class="flex gap-2 mb-2 buteur-row">
                            ...
                            <input type="number" name="minutes_buteurs_equipe1[]" class="form-input w-20" placeholder="Minute" value="<?php echo e(old('minutes_buteurs_equipe1.'.$i, $buts[$i]->minute ?? null)); ?>">
                ...
                <div id="buteurs-equipe2-list">
                    ...
                    <?php for($i = 0; $i < $nb; $i++): ?>
                        <div class="flex gap-2 mb-2 buteur-row">
                            ...
                            <input type="number" name="minutes_buteurs_equipe2[]" class="form-input w-20" placeholder="Minute" value="<?php echo e(old('minutes_buteurs_equipe2.'.$i, $buts[$i]->minute ?? null)); ?>">
                            <button type="button" class="remove-buteur bg-red-500 text-white px-2 rounded">X</button>
                        </div>
                    <?php endfor; ?>
                </div>
                ...
                <div id="cartons-equipe1-list">
                    ...
                    <?php for($i = 0; $i < $nb; $i++): ?>
                        <div class="flex gap-2 mb-2 carton-row">
                            ...
                            <input type="number" name="minutes_cartons_equipe1[]" class="form-input w-20" placeholder="Minute" value="<?php echo e(old('minutes_cartons_equipe1.'.$i, $cartons[$i]->minute ?? null)); ?>">
                ...
                <div id="cartons-equipe2-list">
                    ...
                    <?php for($i = 0; $i < $nb; $i++): ?>
                        <div class="flex gap-2 mb-2 carton-row">
                            ...
                            <input type="number" name="minutes_cartons_equipe2[]" class="form-input w-20" placeholder="Minute" value="<?php echo e(old('minutes_cartons_equipe2.'.$i, $cartons[$i]->minute ?? null)); ?>">
                            <button type="button" class="remove-carton bg-red-500 text-white px-2 rounded">X</button>
                        </div>
                    <?php endfor; ?>
                </div>
        ...
        <a href="<?php echo e(route('admin.rencontres.index')); ?>" class="ml-4 text-gray-600 hover:underline">Annuler</a>
    </form>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div>
            <h4 class="font-semibold mb-2 text-blue-700 dark:text-blue-300">Effectif <?php echo e($rencontre->equipe1->nom ?? '-'); ?></h4>
            <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
[$__name, $__params] = $__split('effectif-match-form', ['matchId' => $rencontre->id, 'equipeId' => $rencontre->equipe1->id ?? null]);

$__html = app('livewire')->mount($__name, $__params, 'effectif-'.$rencontre->id.'-'.$rencontre->equipe1->id, $__slots ?? [], get_defined_vars());
...
?>
        ...
        <div>
            <h4 class="font-semibold mb-2 text-blue-700 dark:text-blue-300">Effectif <?php echo e($rencontre->equipe2->nom ?? '-'); ?></h4>
            <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
[$__name, $__params] = $__split('effectif-match-form', ['matchId' => $rencontre->id, 'equipeId' => $rencontre->equipe2->id ?? null]);

$__html = app('livewire')->mount($__name, $__params, 'effectif-'.$rencontre->id.'-'.$rencontre->equipe2->id, $__slots ?? [], get_defined_vars());
...
<div class="flex justify-end mt-8">
    <a href="<?php echo e(route('admin.rencontres.show', $rencontre)); ?>" class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded shadow">
...
<script>
window.joueursEquipe1 = <?php echo json_encode($joueursEquipe1 ?? [], 15, 512) ?>;
window.joueursEquipe2 = <?php echo json_encode($joueursEquipe2 ?? [], 15, 512) ?>;
