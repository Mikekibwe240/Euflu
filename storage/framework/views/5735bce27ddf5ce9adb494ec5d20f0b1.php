...
<?php $__env->startSection('title', 'Ajouter un Joueur'); ?>

<?php $__env->startSection('header'); ?>
    Ajouter un Joueur (Saison : <?php echo e($saison?->nom ?? 'Aucune'); ?>)
...
<?php endif; ?>
    <?php endif; ?>
    <form action="<?php echo e(route('admin.joueurs.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
        <?php echo csrf_field(); ?>
        <div>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            ...
            <input type="text" name="prenom" class="w-full mt-1 p-3 border border-bl-border rounded bg-bl-dark text-white focus:ring-2 focus:ring-bl-accent focus:border-bl-accent transition" required value="<?php echo e(old('prenom')); ?>">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            ...
            <input type="date" name="date_naissance" class="w-full mt-1 p-3 border border-bl-border rounded bg-bl-dark text-white focus:ring-2 focus:ring-bl-accent focus:border-bl-accent transition" required value="<?php echo e(old('date_naissance')); ?>">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            ...
            <input type="text" name="poste" class="w-full mt-1 p-3 border border-bl-border rounded bg-bl-dark text-white focus:ring-2 focus:ring-bl-accent focus:border-bl-accent transition" required value="<?php echo e(old('poste')); ?>">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            ...
            <input type="text" name="numero_licence" class="w-full mt-1 p-3 border border-bl-border rounded bg-bl-dark text-white focus:ring-2 focus:ring-bl-accent focus:border-bl-accent transition" value="<?php echo e(old('numero_licence')); ?>">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            ...
            <input type="text" name="numero_dossard" class="w-full mt-1 p-3 border border-bl-border rounded bg-bl-dark text-white focus:ring-2 focus:ring-bl-accent focus:border-bl-accent transition" value="<?php echo e(old('numero_dossard')); ?>">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            ...
            <input type="text" name="nationalite" class="w-full mt-1 p-3 border border-bl-border rounded bg-bl-dark text-white focus:ring-2 focus:ring-bl-accent focus:border-bl-accent transition" value="<?php echo e(old('nationalite')); ?>">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\MIKE KIBWE\Documents\Learning\UDBL\L4 GL\TFC\Application\Euflu\resources\views/admin/joueurs/create.blade.php ENDPATH**/ ?>