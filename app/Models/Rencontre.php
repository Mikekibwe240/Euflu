...
{
    protected $fillable = [
        'pool_id', 'saison_id', 'equipe1_id', 'equipe2_id', 'equipe1_libre', 'logo_equipe1_libre', 'equipe2_libre', 'logo_equipe2_libre', 'date', 'heure', 'stade', 'journee', 'type_rencontre', 'score_equipe1', 'score_equipe2', 'mvp_id', 'mvp_libre', 'mvp_libre_equipe'
    ];
