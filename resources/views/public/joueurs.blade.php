...
<div class="max-w-6xl mx-auto py-8 px-2 sm:px-4 md:px-6 lg:px-0">
    ...
    <form method="GET" class="flex flex-wrap gap-2 md:gap-4 items-center mb-6 md:mb-8">
        ...
        <input type="text" name="nom" value="{{ request('nom') }}" placeholder="Nom, prénom..." class="px-3 md:px-4 py-2 rounded border-2 border-[#e2001a] focus:outline-none focus:ring-2 focus:ring-[#e2001a] min-w-[120px] md:min-w-[180px] text-sm md:text-base" />
