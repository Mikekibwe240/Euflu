    ...
    <div class="flex h-screen">
        ...
        <aside class="w-64 bg-white dark:bg-gray-800 shadow-lg flex flex-col">
            ...
            <nav class="flex-1 mt-6 space-y-2 px-4">
                ...
                {{-- <a href="/admin/profile" class="block py-2.5 px-4 rounded-lg hover:bg-blue-100 dark:hover:bg-blue-900 font-medium transition">Mon profil</a> --}}
            </nav>
        </aside>
        <div class="flex-1 flex flex-col">
            ...
            <header class="flex items-center justify-between bg-white dark:bg-gray-800 shadow px-8 py-4 border-b border-gray-200 dark:border-gray-700">
                <div class="text-lg font-semibold text-gray-800 dark:text-white">@yield('header', 'Tableau de bord')</div>
                <div class="flex items-center gap-4">
                    ...
                    <div x-data="{ open: false }" class="relative">
                        <button @click="open = !open" class="flex items-center gap-2 focus:outline-none">
                            ...
                            <span class="hidden md:inline text-gray-700 dark:text-gray-200 font-medium">{{ auth()->user()->name ?? 'Profil' }}</span>
