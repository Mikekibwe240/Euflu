...
<body class="min-h-screen bg-[#18181b] text-white font-sans transition-colors duration-300">
    <nav class="bg-[#23272a] shadow sticky top-0 z-50 border-b-4 border-[#6fcf97] bundesliga-header">
        <div class="w-full max-w-7xl mx-auto flex items-center justify-between h-16 px-0 sm:px-0">
            <div class="flex items-center gap-2 min-w-[160px] pl-0 mr-0">
                <div class="flex items-center justify-center h-12 w-12 bg-white rounded-full border-2 border-[#E2001A] shadow-md ml-0">
                    <img src="/storage/img_euflu/fecofa.png" alt="Logo Fecofa" class="h-10 w-10 object-contain" style="display:block;margin:auto;" />
                </div>
                <span class="bundesliga-logo ml-2 align-middle flex items-center" style="line-height:1;">EUFLU</span>
            </div>
            <div class="bundesliga-menu hidden md:flex gap-4 font-bold uppercase text-white text-sm tracking-wider flex-1 justify-start" style="margin-left:6rem;">
    ...
    <footer class="mt-16 border-t pt-8 text-center text-gray-500 dark:text-gray-400">
        ...
        <div>© {{ date('Y') }} EUFLU. Tous droits réservés.</div>
    </footer>
    @yield('scripts')
</body>
</html>
